...
git clone --single-branch --depth 1 --branch dev https://github.com/gentoo/guru.git || git -C ./guru pull

find "$(realpath ./guru)" -maxdepth 2 -type d -regextype posix-extended -regex '.*/.+/.+' | while IFS='' read -r packageName; do
